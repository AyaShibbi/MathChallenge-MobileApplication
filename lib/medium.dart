    ...
    Navigator.pushReplacement(
      ...
      MaterialPageRoute(
        builder: (context) => ScoreBoard(
          score: score,
          totalQuestions: (score + (lives+5))-1,
          level: "Medium Level",
        ),
      ),
    );
...
class MathEquation {
  ...
  static MathEquation generateRandomEquation() {
    final random = Random();
    int n1 = random.nextInt(40) + 11; // Random number between 11 and 50
    int n2 = random.nextInt(40) + 11;
  ...
  List<int> generateOptions() {
    ...
    while (options.length < 4) {
      int option = random.nextInt(41) + 10; // Random number between 50 and 10
